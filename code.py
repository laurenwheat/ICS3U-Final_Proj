...
def menu_scene ():
    ...
    text = []
    text1 = stage.Text(width=9, height=12, font=None, palette=constants.RED_PALETTE,
buffer=None)
    text1.move(20,10)
        ...
        for alien_number in range(len(aliens)):
            if aliens[alien_number].x > 0:
                if stage.collide(aliens[alien_number].x + 1, aliens[alien_number].y,
                                 aliens[alien_number].x + 15, aliens[aliens].y + 15,
                                 ship.x, ship.y,
                                 ship.x + 15, ship.y + 15):
                    sound.stop()
...
def game_over_scene(final_score): 
    ...
    text = []
    text1 = stage1(width=29, height=14, font=None, palette=constants.BLUE_PALETTE, buffer=None)
    text.move(22, 20)
    text1.text("Final Score: {:0>2d}".format(final_score))
    text.append(text1)
    
    text = []
    text2 = stage1(width=29, height=14, font=None, palette=constants.BLUE_PALETTE, buffer=None)
    text.move(43, 60)
    text2.text("GAME OVER")
    text.append(text2)
    
    text = []
    text3 = stage1(width=29, height=14, font=None, palette=constants.BLUE_PALETTE, buffer=None)
    text.move(32, 110)
